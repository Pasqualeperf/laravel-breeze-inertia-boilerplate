...
const Navbar = ({auth}) => {
    ...
    return (
        <>
            <nav className="navbar flex px-3 py-6 justify-between shadow-sm">
                <div className="left-navbar flex">
                    ...
                    <div className="links">
                        <NavLink active={route().current('homepage')} href={route('homepage')} children="link-1" />
                        <NavLink active={route().current('homepage')} href={route('homepage')} children="link-2" />
                        <NavLink active={route().current('homepage')} href={route('homepage')} children="link-3" />
                    </div>
                </div>
